import {FlatList, Text, View, Pressable, Image, TouchableOpacity, ScrollView} from "react-native";
                            ...
                            { ({ pressed }) => (
                                ...
                                <View className="h-full w-1/2 ">
                                    ...
                                    <View className={cn("offer-card__info", isEven ? "pl-10" : "pr-10" )}>
                                        <Text className="h1-bold text-white leading-tight whitespace-nowrap">
                                            {item.title}
                                        </Text>
                                        <Image
                ...
                <View className="flex-between flex-row w-full my-5">
                    <View className="flex-start">
                        ...
                        <TouchableOpacity className="flex-center flex-row gap-x-1 mt-1">
                            <Image source={images.arrowDown} className="size-2" resizeMode="contain"/>
